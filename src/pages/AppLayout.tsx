...
export function AppLayout() {
  return (
    <div className="h-screen grid grid-rows-[min-content_1fr] bg-blue-400 bg-[url(/src/assets/bg.svg)] bg-size-[150px] overflow-hidden select-none">
      <header className="flex justify-between g-4 py-4 px-6 bg-[#F1F2F4] shadow-[0_3px_8px_rgba(0,0,0,0.4)] z-40">
        <Link to="/">
        ...
        <nav>
          <ul className="flex gap-4">
            <li>
              <Link
                to="statistic"
                className="border-b-2 border-transparent hover:border-blue-900 text-lg leading-none text-blue-900"
              >
                Statistic
              </Link>
            </li>
